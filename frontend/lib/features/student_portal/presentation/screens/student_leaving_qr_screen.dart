  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: asyncCodes.when(
        ...
        error: (err, _) => ErrorState(message: 'Failed to load QR', onRetry: () => ref.invalidate(_qrCodesProvider)),
        data: (codes) => Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Card(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(24),
                    child: QrImageView(data: codes.leavingQr ?? '', version: QrVersions.auto, size: 260),
                  ),
                ),
                const SizedBox(height: 20),
                const Text('Show this code to your teacher when you leave the institute.', textAlign: TextAlign.center),
              ],
            ),
          ),
        ),
