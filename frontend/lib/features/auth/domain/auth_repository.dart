...
abstract class AuthRepository {
  Future<AuthSession> loginSuperAdmin({required String email, required String password});

  Future<AuthSession> loginInstitute({required String instituteCode, required String password});

  Future<AuthSession> loginTeacher({required String email, required String password});
